          ...
          <div className="sign-in-methods-container">
            ...
            <section className='social-media-sign-in-container'>
              ...
              <div className='btn-container'>
                ...
                <button className='social-sign-in-btn' onClick={signInWithGithub}><img className='social-logo' src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg" /> Sign In with your Github Account </button>
              </div>
            </section>
          </div>
        </div>
